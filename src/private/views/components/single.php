        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            <div class="mainheading">
                ...
                <div class="row post-top-meta">
                    ...
                    <div class="col-md-10">
                        <a class="link-dark author" href="/admin">Sal</a><a href="#" class="btn follow">Follow</a>
                        <span class="author-description">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium culpa iure maiores, tenetur eligendi quia ea. Magnam culpa modi libero deleniti, enim provident, nam incidunt dolores quae velit repellendus labore. </span>
                        <span class="post-date date">22 July 2017</span><span class="dot"></span><span class="post-read">25 min read</span>
                    </div>
                </div>
                <!-- End Top Menta -->

                <h1 class="posttitle title">18 Things You Should Learn Before Moving Into a New Home</h1>

            </div>

            <!-- Begin Featured Image -->
            <img class="featured-image img-fluid" src="../public/assets/img/demopic/<?php echo rand(1, 9) ?>.jpg" alt="">
            <!-- End Featured Image -->
